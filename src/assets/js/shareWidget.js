...
function shareLinkUpdate1(){
  ...
  var winProps = 'channelmode=no,directories=no,fullscreen=no,status=no,toolbar=no,width=400,height=400,modal=yes,alwaysRaised=yes,resizable=yes',
      ...
      sum1 = $('meta[name="abstract"]:first').length ? $('meta[name="abstract"]:first').attr('content') : '',
      sum2 = $('meta[property="og:description"]:first').length ? $('meta[property="og:description"]:first').attr('content') : '',
      sum3 = $('meta[name="Description"]:first').length ? $('meta[name="Description"]:first').attr('content') : '', 
