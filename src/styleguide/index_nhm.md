...
Unlike the templates in Teamsite, the NHM pages are all free-hand code.  The developer will need to create the approriate containers to house thepage copntents.
